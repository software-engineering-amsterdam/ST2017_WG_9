...
{- The easiest way I could think of is return the bases that are '1' in a string. -}
{- So for instance "101" would return [2,0] -}
base2 :: String -> [Int]
...
{- Simon provided me with this function we can feed into quickcheck to check -}
{- for equivalence. -}
{- Output of run: -}
{- Ok, modules loaded: Exercise1. -}
{- *Exercise1> quickCheck testExM' -}
{- +++ OK, passed 100 tests. -}
testExM' :: Positive Integer -> Positive Integer -> Positive Integer -> Bool
testExM' (Positive x) (Positive y) (Positive m) = exM x y m == expM x y m
