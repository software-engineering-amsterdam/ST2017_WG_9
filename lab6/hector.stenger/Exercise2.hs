...
{- Starting with 'low' values no difference is really noticed. -}
{- The only difference there is to notice is the increased bytes the -}
{- second function requires -}
{- *Exercise2> testOne -}
{- 3 -}
{- (0.00 secs, 77,704 bytes) -}
{- *Exercise2> testOne' -}
{- 3 -}
{- (0.00 secs, 82,568 bytes) -}
testOne = expM 2 3 5
testOne' = exM 2 3 5

{- Upping the values still does not really make a difference, we do still notice -}
{- a small increase in used memory -}
{- *Exercise2> testTwo -}
{- 0 -}
{- (0.00 secs, 82,856 bytes) -}
{- *Exercise2> testTwo' -}
{- 0 -}
{- (0.00 secs, 94,472 bytes) -}
testTwo = expM 200 300 50
testTwo' = exM 200 300 50

{- Slight change in time when increasing arguments we also see alot more
- memory used but this time its the first function that needs alot more bytes -}
{- *Exercise2> testThree -}
{- 0 -}
{- (0.01 secs, 235,504 bytes) -}
{- *Exercise2> testThree' -}
{- 0 -}
{- (0.00 secs, 134,648 bytes) -}
testThree = expM 20000 30000 500
testThree' = exM 20000 30000 500

{- The first real cracks in the old implementation start to -}
{- show when we again increase the value of the arguments -}
{- Not only the time is drastically slower, the amount of memory -}
{- needed is increased by more than a 100 fold -}
{- *Exercise2> testFour -}
{- 0 -}
{- (0.54 secs, 22,756,408 bytes) -}
{- *Exercise2> testFour' -}
{- 0 -}
{- (0.00 secs, 182,544 bytes) -}
testFour = expM 2000000 3000000 5000
testFour' = exM 2000000 3000000 5000

{- This last one is where the real differenes start to show. The -}
{- new function can compute the result while the old one hangs. -}
{- *Exercise2> testFive' -}
{- 0 -}
{- (0.01 secs, 216,728 bytes) -}
testFive = expM 200000000 300000000 50000
testFive' = exM 200000000 300000000 50000
