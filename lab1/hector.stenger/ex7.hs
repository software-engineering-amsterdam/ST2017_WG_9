...
{- time: 4.5 hours.. My undiagnosed form of OCD, just kidding, thought it was a  -}
{- good idea to come up with an abstract pattern for checking the 3 creditcards numbers. The result -}
{- looks fine, but is overengineered. -}
